...
- **Primary:** `RB-K8S-CRASH-005` — `docs/runbooks/runbook-05-kubernetes-crashloopbackoff.md` *(closest: startup/pull failures; see runbook “Out of scope: ImagePullBackOff” — treat as registry/IAM.)*
