...
**Also useful:** [`../README.md`](../README.md) (repo landing), [`../frontend/README.md`](../frontend/README.md) (Next.js), [`../workspaces/README.md`](../workspaces/README.md) (paths), deploy docs under [`deploy/`](deploy/), Version 1 narrative in [`build-journey/execution-v1.md`](build-journey/execution-v1.md).
