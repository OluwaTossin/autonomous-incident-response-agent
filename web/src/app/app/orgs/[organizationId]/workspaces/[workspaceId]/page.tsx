import { Activity, ArrowRight, ListTree, Plug, Settings } from "lucide-react";
  ...
  return (
    <AppShell organizations={bootstrap.organizations} organization={organization} workspace={workspace} user={session} csrfToken={session.csrfToken}>
      ...
      <div className="action-list">
        ...
        <Link href={`${base}/integrations`}><Plug aria-hidden="true" size={20} /><div><strong>Integrations</strong><span>Configure short-lived AWS account access and verify read capabilities.</span></div><ArrowRight aria-hidden="true" size={18} /></Link>
